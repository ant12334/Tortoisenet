...
import (
	...
	"github.com/ant12334/Tortoisenet/app"
)
...
// genesisCommand builds genesis-related `Tortoisenetd genesis` command. Users may provide application specific commands as a parameter
